...
const AuditPanel: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background-dark p-6 text-white font-sans relative custom-scrollbar">
      
      {/* HEADER & TOP CONTROLS */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8 border-b border-border-dark pb-6">
                              ...
                              >
                                  ...
                                  <td className="px-6 py-4">
                                      <span className={`px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-tight border ${
                                          trade.Vertical === 'Picks EV+' ? 'bg-emerald-500/5 border-emerald-500/20 text-emerald-400' : 
                                  ...
                                  <td className="px-6 py-4 text-center">
                                      <span className={`text-[9px] font-black px-2.5 py-1 rounded uppercase tracking-widest ${
                                          trade.Resultado_tip === 'WIN' ? 'bg-emerald-500/10 text-emerald-500' : 

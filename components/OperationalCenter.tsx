...
import {
  ...
  Store, Building2, Terminal, Clock, Loader2, Server
} from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-2 sm:py-3 bg-[#121212] border border-[#1f1f1f] rounded-lg sm:rounded-xl text-[10px] font-black uppercase text-[#888] hover:text-white hover:border-white/20 transition-all active:scale-95"
            >
              <Server size={16} /> <span className="hidden lg:inline">Orchestrator</span>
            </button>

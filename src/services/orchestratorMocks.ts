...
export const MOCK_PROFILES: ProfileItem[] = [
    {
        id: 'P-01', adsId: 'j829x91', name: 'Bet365-ES-01', group: 'ELITE', sport: 'F├║tbol', bookie: 'Bet365', status: 'RUNNING', health: 98, trustScore: 92,
    ...
    {
        id: 'P-03', adsId: 'm102z33', name: 'Pinny-UK-02', group: 'STANDARD', sport: 'F├║tbol', bookie: 'Pinny', status: 'ERROR', health: 0, trustScore: 74,
    ...
    {
        id: 'P-04', adsId: 'x555y11', name: 'Betfair-ES-09', group: 'ELITE', sport: 'F├║tbol', bookie: 'Betfair', status: 'IDLE', health: 100, trustScore: 95,
        latency: 60, memory: 0, nodeId: 'ELITE-MAIN-01', lastAction: 'CLOSE',
        owner: 'William Mu├▒oz - Cuenca', browserScore: 100, fingerprintScore: 100, cookieStatus: 'OK',
    ...
    {
        id: 'P-07', adsId: 'c333d44', name: 'Betcris-EC-01', group: 'STANDARD', sport: 'F├║tbol', bookie: 'Betcris', status: 'IDLE', health: 88, trustScore: 85,
    ...
    {
        id: 'P-09', adsId: 'g777h88', name: 'Betsson-PE-04', group: 'STANDARD', sport: 'F├║tbol', bookie: 'Betsson', status: 'WARMING', health: 70, trustScore: 80,
...
export const MOCK_ALERTS: Alert[] = [
    { id: 1, type: 'Nodo Offline', message: 'STD-BACKUP perdi├│ conexi├│n', severity: 'Critical', time: '5m ago', nodeId: 'N-03', read: false },

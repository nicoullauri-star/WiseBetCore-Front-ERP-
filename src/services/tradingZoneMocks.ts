...
const sports = ['F├║tbol', 'Tenis', 'Basket', 'Esports'];
const operators = ['NICOL├üS', 'SANTIAGO', 'ANDR├ëS', 'MATEO'];
...
export const MOCK_SCENARIOS_V8: SignalV8[] = [
    { id: 'S-FUT', event: 'Real Madrid vs Liverpool', sport: 'F├║tbol', market: 'Goles > 2.5', fairOdd: 1.85, minOdd: 1.75, recommendedStake: 800 },
    { id: 'S-TEN', event: 'Nadal vs Federer', sport: 'Tenis', market: 'Ganador 2-0', fairOdd: 2.10, minOdd: 2.00, recommendedStake: 300 },
    { id: 'S-BAS', event: 'Lakers vs Bulls', sport: 'Basket', market: 'H├índicap -5.5', fairOdd: 1.91, minOdd: 1.85, recommendedStake: 500 },
    { id: 'S-ESP', event: 'Faze vs G2', sport: 'Esports', market: 'Mapa 2 Winner', fairOdd: 1.70, minOdd: 1.65, recommendedStake: 1000 },
    { id: 'S-MIX', event: 'Multi-Evento Test', sport: 'F├║tbol', market: 'BTTS Yes', fairOdd: 1.95, minOdd: 1.90, recommendedStake: 1500 },
];
